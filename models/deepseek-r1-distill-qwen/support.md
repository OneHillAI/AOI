# Support - DeepSeek-R1-Distill (Qwen base)
...
trade-offs at the smallest sizes, and confusing a distil with the full R1. Not exhaustive -
the very large community around these consumer-runnable models is the practical first stop.

<!-- item: release-versioning -->
## Versions, changelog & cadence

The R1-Distill-Qwen sizes are published on the verified `deepseek-ai` organisation. There is
...
The `deepseek-ai` Hugging Face organisation and GitHub, plus a very large community ecosystem
around these consumer-runnable distils.
...
The standing issues are the absence of own safety tuning, inherited China-aligned censorship,
and quant-quality trade-offs at the smallest sizes. See Assess for the detail.
